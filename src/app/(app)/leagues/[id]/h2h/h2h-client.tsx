      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <select
            ...
            className="w-full text-sm bg-secondary border border-overlay-border rounded-md px-2 py-2 text-foreground"
          >
            {members.map((m) => (
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-6 space-y-6 lg:space-y-0">
          ...
          <Card className="border border-overlay-border">
            <CardContent className="pt-5">
              ...
              <div className="mt-4 pt-4 border-t border-overlay-border grid grid-cols-2 gap-4 text-sm">
              ...
              {comparison.matches.length === 0 ? (
                ...
                <div className="space-y-1">
                  ...
                  {comparison.matches.map((m) => {
                    ...
                    return (
                      <div key={m.matchNum} className="flex items-center py-2 px-2 rounded bg-overlay-subtle">
