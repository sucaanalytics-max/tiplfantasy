...
const getPlayerStatsData = unstable_cache(
  async (): Promise<{ allPlayers: PlayerAgg[]; matchCount: number }> => {
    ...
    return { allPlayers: [...aggMap.values()], matchCount: matchIds.length }
  },
  ["player-stats"],
...
export default async function StatsPage() {
  ...
  const { allPlayers, matchCount } = await getPlayerStatsData()
  ...
  return (
    <PageTransition>
      <StatsClient players={allPlayers} matchCount={matchCount} />
    </PageTransition>
  )
}
