...
export function NavBar({ isAdmin = false }: { isAdmin?: boolean }) {
  ...
  return (
    <>
      {/* Mobile bottom nav */}
      <nav aria-label="Main navigation" className="fixed bottom-0 left-0 right-0 z-50 glass-subtle border-t border-white/[0.06] pb-[env(safe-area-inset-bottom)] md:hidden">
