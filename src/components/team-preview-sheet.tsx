        ...
        <SheetContent side="bottom" className="rounded-t-2xl p-0 max-h-[85dvh] flex flex-col">
          <div className="max-w-lg mx-auto w-full flex flex-col flex-1 min-h-0">
                ...
                <div className="pb-2">
                  {sortedPlayers.map((player) => {
                    ...
                    return (
                      <div
                        key={player.id}
                        className="flex items-center gap-3 py-2.5 px-4 border-b border-overlay-border last:border-0"
                      >
                        <span
                          className={cn(
            ...
            {status === "upcoming" && data !== "loading" && data !== null && (
              <div className="px-4 pt-3 pb-[max(1rem,env(safe-area-inset-bottom))] border-t border-overlay-border">
                <Button
                  variant="outline"
