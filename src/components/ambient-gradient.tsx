  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.55 0.15 220), transparent 70%)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.55 0.20 350), transparent 70%)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.50 0.15 230), transparent 70%)",
